...
import com.hwangjr.utils.shell.ShellHelper;
...
public class PackageHelper {
    ...
    public static final int install(Context context, String filePath) {
        if (isSystemApplication(context) || ShellHelper.checkRootPermission()) {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link #INSTALL_SUCCEEDED} means install success, other means failed. details see
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        ShellHelper.CommandResult commandResult = ShellHelper.exec(command.toString(), !isSystemApplication(context), true);
    ...
    public static int getInstallLocation() {
        ShellHelper.CommandResult commandResult = ShellHelper.exec(
     ...
     * the {@link PackageManager#INSTALL_ALLOW_TEST} flag.
     */
